...
//    { 0x0036, "af", "Afrikaans", "Afrikaans", "Afrikaans", 1252, 850, "ZAF", "AFK" },
    ...
    { 0x0005, "cs", "Czech", "Czech", "ceština", 1250, 852, "CZE", "CSY" },
    { 0x0405, "cs-CZ", "Czech(Czech Republic)", "Czech", "ceština (Ceská republika)", 1250, 852, "CZE", "CSY" },
    ...
    { 0x082E, "wee-DE", "Lower", "Sorbian", "(Germany) Lower Sorbian dolnoserbšcina (Nimska)", 1252, 850, "GER", "DSB" },
    ...
    { 0x0018, "ro", "Romanian", "Romanian", "româna", 1250, 852, "ROM", "ROM" },
    { 0x0418, "ro-RO", "Romanian(Romania)", "Romanian", "româna (România)", 1250, 852, "ROM", "ROM" },
    ...
    { 0x083B, "se-SE", "Sami,", "Northern", "(Sweden) Sami (Northern) davvisámegiella (Ruotta)", 1252, 850, "SWE", "SMF" },
    { 0x203B, "sms-FI", "Sami,", "Skolt", "(Finland) Sami (Skolt) sääm´kiõll (Lää´ddjânnam)", 1252, 850, "FIN", "SMS" },
    ...
    { 0x041B, "sk-SK", "Slovak(Slovakia)", "Slovak", "slovencina (Slovenská republika)", 1250, 852, "SVK", "SKY" },
    ...
    { 0x042E, "wen-DE", "Upper", "Sorbian", "(Germany) Upper Sorbian hornjoserbšcina (Nemska)", 1252, 850, "GER", "HSB" },
    ...
    { 0x002A, "vi", "Vietnamese", "Vietnamese", "Tiê´ng Viê?t", 1258, 1258, "VNM", "VIT" },
    { 0x042A, "vi-VN", "Vietnamese(Vietnam)", "Vietnamese", "Tiê´ng Viê?t (Viê?t Nam)", 1258, 1258, "VNM", "VIT" },
